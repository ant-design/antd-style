...
const useStyles = createStyles((_, sharedItemStyles: any) => ({
  container: {
...
const AntdStyleWithProps: FC = () => {
  const { styles } = useStyles(sharedItemStyles);
...
export default AntdStyleWithProps;
